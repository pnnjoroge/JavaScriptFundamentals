...
function Chirp(author, message, date) {
  ...
  this.printPost = function () {
    ...
    console.log(`By ${this.author} on ${this.date.toString()}`)
  }
// this.wasBefore = function(otherChirp) {
//   return (this.date.getTime() - otherChirp.date.getTime()) < 0
...
chirpsByJohn[2].this.printPost;

// true
console.log(chirpsByJohn[0]);

// false
console.log(chirpsByJohn[1]);
